            ...
            <div class="page">
                <div class="row">
                    ...
                    <div class="block-heading" id="details">
                        <?php 
                        if(!empty($edit_url)):
                           echo '<a href="'.$edit_url.'" class="btn btn-sm btn-primary pull-right">'.__('Create new project ','framework').'<i class="fa fa-long-arrow-right"></i></a>';
                        endif; ?>
                           <h4><span class="heading-icon"><i class="fa fa-home"></i></span><?php _e('Your Projects','framework'); ?></h4>
                        </div>
			        ...
			        $property_area = get_post_meta(get_the_ID(),'imic_property_area',true); 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo esc_url(add_query_arg( 'site', get_the_ID(), $edit_url )); ?>" class="action-button"><i class="fa fa-pencil"></i> <span><?php _e('Edit','framework'); ?></span></a>
                        ...
                        <?php 
                            ...
                            echo '<h3>'.__("Create your project page and start perfecting your team!",'framework').'<a href="'.$edit_url.'" class="btn btn-sm btn-primary">'.__('Create new project ','framework').'<i class="fa fa-long-arrow-right"></i></a></h3>';
                        endif;
