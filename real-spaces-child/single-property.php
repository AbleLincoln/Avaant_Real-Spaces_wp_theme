        ...
        <div class="row avnt-title-bar avnt-box">
          ...
          <div class="col-md-5">
            <div class="row social-buttons">
              <div class="col-md-4">
<!--                <button class="btn btn-default btn-block" type="submit">Favorite</button>-->
                ...
                <?php if(!empty($property_price)) { ?>
                  ...
                  <?php } ?>
                    <div class="property-amenities clearfix avaant-hidden">
                      <?php if(!empty($property_term_type)) { ?><span class="area"><strong><?php _e('For','framework'); ?></strong><?php echo $property_term_type; ?></span>
                        <?php } ?>
                          <?php if(!empty($property_area)) { ?><span class="area"><strong><?php echo $property_area; ?></strong><?php _e('Area','framework'); ?></span>
                            <?php } ?>
                              <?php if(!empty($property_baths)) { ?><span class="baths"><strong><?php echo $property_baths; ?></strong><?php _e('Baths','framework'); ?></span>
                                <?php } ?>
                                  <?php if(!empty($property_beds)) { ?><span class="beds"><strong><?php echo $property_beds; ?></strong><?php _e('Beds','framework'); ?></span>
                                    <?php } ?>
                                      <?php if(!empty($property_parking)) { ?><span class="parking"><strong><?php echo $property_parking; ?></strong><?php _e('Parking','framework'); ?></span>
                                        <?php } ?> <span class="parking">
                    ...
                    <li class="grid-item type-<?php if(!empty($term)) { echo $term->name; } ?>">
                      <div class="property-block">
                        <a href="<?php the_permalink(); ?>" class="property-featured-image">
                          <?php the_post_thumbnail('600-400-size'); ?> <span class="images-count"><i class="fa fa-picture-o"></i> <?php echo $total_images; ?></span>
                            <?php if(!empty($term)) { ?><span class="badges"><?php echo $term->name; ?></span>
                              <?php } ?>
                        </a>
