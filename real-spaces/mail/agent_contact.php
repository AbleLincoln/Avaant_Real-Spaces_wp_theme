...
$subject = $_POST['subject'];
 if(trim($email) == '') {
	...
	echo '<div class="alert alert-error">You must enter some message.</div>';
	exit();
}
...
$e_body = "You have been contacted by $email from your RealSpace's agent form, their additional message is as follows." . PHP_EOL . PHP_EOL;
