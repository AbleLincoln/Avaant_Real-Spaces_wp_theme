function embedSelectedShortcode() {
	...
	if (current_shortcode != -1) {
		...
		var testimonial_scroll = document.getElementById('testimonial-scroll').value;
		...
		if (shortcode_select == 'shortcode-testimonial') {
			shortcodeHTML = '<br/>[testimonial scroll="'+testimonial_scroll+'" number="'+testimonial_count+'" slider="'+testimonial_slider+'" pagination="'+testimonial_pagination+'"]<br/>';	
		}
